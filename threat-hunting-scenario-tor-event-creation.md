...
2. Install it silently: ```tor‑browser‑windows‑x86_64‑portable‑14.5.3.exe```
...
## Created By:
- **Author Name**: Brandon Gentry
- **Author Contact**: www.linkedin.com/in/brandon-gentry-5785bb17a
- **Date**: June 6, 2025
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `June  6, 2025`  | `Brandon Gentry`   
